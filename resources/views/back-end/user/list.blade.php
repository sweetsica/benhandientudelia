    ...
    <div class="container-fluid">
        <div class="form-head align-items-center d-flex mb-sm-4 mb-3">
            ...
            <div>
                ...
                <a href="index.html" class="btn btn-outline-primary"><i class="las la-calendar-plus scale5 mr-3"></i>Filter
                    Date</a>
            </div>
        </div>
        <!-- Add Order -->
                ...
                <div class="table-responsive card-table">
                    <table id="example5" class="display dataTablesCard white-border table-responsive-xl">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge badge-outline-primary">
                                    <i class="fa fa-circle text-primary mr-1"></i>New Patient
                                </span>
                            </td>
                            <td>AB-005</td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="customCheckBox321"
                                           required="">
                        ...
                        <tr>
                            <td>
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="customCheckBox32"
                                           required="">
                        ...
                        <tr>
                            <td>
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="customCheckBox31"
                                           required="">
...
@section('content-footer')
    <!-- Datatable -->
    <script src="{{asset('asset-content/vendor/datatables/js/jquery.dataTables.min.js')}}"></script>
    <script>
        (function ($) {
