...
<head>
    ...
    @if(View::hasSection('content-title'))
        @yield("content-title")
    @else
        <title>Bệnh án điện tử - Nha khoa Delia</title>
    @endif
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('asset-content/images/favicon.png')}}">
    <link href="{{asset('asset-content/vendor/jqvmap/css/jqvmap.min.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('asset-content/vendor/chartist/css/chartist.min.css')}}">
    <!-- Datatable -->
    <link href="{{asset('asset-content/vendor/datatables/css/jquery.dataTables.min.css')}}" rel="stylesheet">
    <link href="{{asset('asset-content/vendor/bootstrap-select/dist/css/bootstrap-select.min.css')}}" rel="stylesheet">
    <link href="{{asset('asset-content/vendor/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css')}}" rel="stylesheet">
...
<div id="main-wrapper">
    ...
    ***********************************-->
    <div class="nav-header">
        <a href="index.html" class="brand-logo">
            <img class="logo-abbr" src="{{asset('asset-content/images/logo.png')}}" alt="">
            <img class="logo-compact" src="{{asset('asset-content/images/logo-text.png')}}" alt="">
            <img class="brand-title" src="{{asset('asset-content/images/logo-text.png')}}" alt="">
        </a>
                ...
                <div class="collapse navbar-collapse justify-content-between">
                    ...
                    <ul class="navbar-nav header-right">
                        ...
                        <li class="nav-item dropdown header-profile">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a href="{{asset('asset-content/app-profile.html')}}" class="dropdown-item ai-icon">
                                    <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                    <span class="ml-2">Profile </span>
                                </a>
                                <a href="{{asset('asset-content/email-inbox.html')}}" class="dropdown-item ai-icon">
                                    <svg id="icon-inbox" xmlns="http://www.w3.org/2000/svg" class="text-success" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                                    <span class="ml-2">Inbox </span>
                                </a>
                                <a href="{{asset('asset-content/page-login.html')}}" class="dropdown-item ai-icon">
    ...
    ***********************************-->
    ...
    <!--**********************************
        Sidebar start
    ***********************************-->
    @include('back-end.sidebar.master')
    <!--**********************************
        Sidebar end
    ***********************************-->
    ...
    ***********************************-->
    <div class="footer">
        <div class="copyright">
            <p>Copyright © Designed &amp; Developed by Sweetsica</a> 2022</p>
        </div>
    </div>
    <!--**********************************
        Footer end
...
<script src="{{asset('asset-content/vendor/chart.js/Chart.bundle.min.js')}}"></script>
<script src="{{asset('asset-content/js/custom.min.js')}}"></script>
<script src="{{asset('asset-content/js/deznav-init.js')}}"></script>
<script  src="{{asset('asset-content/vendor/bootstrap-datetimepicker/js/moment.js')}}"></script>
<script  src="{{asset('asset-content/vendor/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js')}}"></script>
<!-- Chart piety plugin files -->
<script src="{{asset('asset-content/vendor/peity/jquery.peity.min.js')}}"></script>

<!-- Apex Chart -->
<script src="{{asset('asset-content/vendor/apexchart/apexchart.js')}}"></script>
